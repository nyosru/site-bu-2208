<template>
  <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="">
          ...
          <p>
            нормальное описание которое подкрепляет мысли смотрящего и немного
            двигает в свою сторону
          </p>
        </div>
        <div class="">
        ...
        <div class="">
          ...
          <p class="flex items-center justify-center md:justify-start mb-4">
            <a
              ...
              title="Позвоните представителю проекта по телефону"
            >
              <svg
                aria-hidden="true"
                focusable="false"
    ...
    <div class="bg-gray-200 grid grid-1 md:grid-cols-2 gap-8">
      ...
      <div class="text-center p-6">
        ...
        >
          Создание сайта: Команда ПХП котиков PHP-cat.com
        </a>
      </div>
    </div>
  </footer>
